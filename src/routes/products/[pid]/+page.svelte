		...
		<div class="grid gap-8 md:grid-cols-2">
			...
			<div class="md:py-8">
				...
				<div class="mb-2 md:mb-3">
					<span class="mb-0.5 inline-block text-gray-500">By {product.owner_name}</span>
					<h2 class="text-2xl font-bold text-gray-800 lg:text-3xl">{product.product_name}</h2>
				</div>
				<!-- name - end -->
				...
				<div class="mb-4">
					<div class="flex items-end gap-2">
						<span class="text-xl font-bold text-gray-800 md:text-2xl">₹{product.prize}.00</span>
						<span class="mb-0.5 text-red-500 line-through">₹{product.prize + 400}.00</span>
					</div>
